...
const merchantLogoURL=d=>{try{const u=new URL(d?.source||'');const host=u.hostname.replace(/^www\\./,'');return host?'https://www.google.com/s2/favicons?domain='+encodeURIComponent(host)+'&sz=256':''}catch{return ''}};
